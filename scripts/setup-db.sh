...
sudo -u postgres psql -c "CREATE USER lecabanon_user WITH PASSWORD 'LeCabanon44200%3F';" 2>/dev/null || echo "User existe déjà"
...
echo "DATABASE_URL=postgresql://lecabanon_user:LeCabanon44200%3F@localhost:5432/lecabanon"
