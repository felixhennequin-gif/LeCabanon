...
sudo -u postgres psql -c "CREATE USER lecabanon_user WITH PASSWORD 'lecabanon123';" 2>/dev/null || echo "User existe déjà"
...
echo "DATABASE_URL=postgresql://lecabanon_user:lecabanon123@localhost:5432/lecabanon"
